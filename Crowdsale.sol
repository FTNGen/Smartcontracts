...
library Address {
    function isContract(address account) internal view returns (bool) {
        bytes32 codehash;
        bytes32 accountHash = 0x2885d94446c01868b5035632bc15f17bbe114b0799d30deffeaaf685222bae4a;
...
contract FTNG_CROWDSALE is Context, ReentrancyGuard{
    ...
    constructor () public {
        ...
        rate = uint256(30000);
        walletAddress = 0xbA8A99858Ba7643595dC27baD09c2381e6f17057; //Fund Receiver
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Maximum amount is 100 BNB");
